...
\begin{figure}[h]
  ...
  \includegraphics[width=0.52\figwidth]{etarun1.png}
  ...
  \end{subfigure}
  \begin{subfigure}[b]{0.5\figwidth}
  \includegraphics[width=0.52\figwidth]{phirun1.png}
...
\begin{figure}[h]
  \centering
  \begin{subfigure}[b]{0.5\figwidth}
  \includegraphics[width=0.52\figwidth]{pileuprun1.png}
  ...
  \end{subfigure}
\begin{subfigure}[b]{0.5\figwidth}
\includegraphics[width=0.52\figwidth]{ptrun1.png}
