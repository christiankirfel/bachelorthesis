...
\newcommand{\thesistitle}{Development of a Framework for Particle Flow Data-MC Comparison using Run 2 Data}
...
\newcommand*{\thesisrefereetwo}{Dr.\ Tatjana Lenz}
...
\include{thesis_pflow}

\include{thesis_framework}

\include{thesis_result}
